Feature: Finding routes
  ...
  Scenario: an application with a custom routes file
    Given a file "custom_routes.js" with the content
      """
      module.exports = ({ GET }) => {
    ...
    And a file "controllers/users_controller.js" with the content
      ...
      """
    And an exprestive app with the option "routesFilePath" set to `"./custom_routes.js"`
  ...
  Scenario Outline: routes can be referred to with any case
    Given a file "routes.js" with the content
      ...
      """
    And a file "controllers/change_case_controller.js" with the content
      """
      module.exports = class ChangeCaseController {
        index(req, res) {
          res.end();
        }
      }
