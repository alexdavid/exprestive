(function() {
  ...
  Exprestive = (function() {
    function Exprestive(baseDir, options) {
      ...
      this.resourceHelperMethod = __bind(this.resourceHelperMethod, this);
    ...
    Exprestive.prototype.getRoutesHelperMethods = function() {
      ...
      helperMethods = {
        resource: this.resourceHelperMethod
      };
    ...
    Exprestive.prototype.resourceHelperMethod = function(controllerName) {
